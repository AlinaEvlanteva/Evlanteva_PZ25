...
try:
    ...
    N = int(input("Введите номер действия в диапазоне от 1 до 4: "))

    if B == 0 or N < 0 or N > 4:
        print("Проверьте правильность введёных данных! B: не должно быть = 0; N: должен быть в диапозоне от 1 до 4.")
    elif N == 1:
